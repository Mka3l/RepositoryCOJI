...
import GestionUtilisateur from './Utilisateurs/GestionUtilisateurs';
const getFlagForCountry = (country) => {
  const countryFlags = {
    ...
    'Utilisateurs:':[MadagascarFlag, ComoresFlag, MayotteFlag, MauriceFlag, SeychellesFlag, MaldivesFlag, FranceFlag, FranceFlag]
      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-10" style={{ background: 'rgba(245, 245, 245, 0.0)', display: 'flex', flexDirection: 'column', boxShadow: '0px 5px 20px -5px', height: 'auto', paddingBottom: '50px' }}>
            ...
            {currentPage === 'Gestion utilisateur' && <GestionUtilisateur />}
          </div>
        </div>
      </div>
    </div>
