...
const Sidebar = ({ onPageChange }) => {
  ...
  const categoriesWithSubcategories = {
    ...
    'Référence Médicale': [],
    'Planning d\'activité complémentaire': ['Calendrier des jeux', 'Calendrier des événements'],
    'Utilisateurs': []
  };
  ...
  const getPageNameFromCategory = (category, subcategory) => {
    switch (category) {
      ...
      case 'Planning d\'activité complémentaire':
        switch (subcategory){
          ...
          case 'Calendrier des événements':
            ...
            default: 
            return 'Planning d\'activité complémentaire';
        }
    }
  };
