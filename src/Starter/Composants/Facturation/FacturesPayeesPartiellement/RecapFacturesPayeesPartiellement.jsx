...
const RecapFacturesPayeesPartiellement = () => {
  const columns = [
    "NOMBRE \r\nHOTELS ",
    "NOMBRE TOTAL DE \r\nSEJOUR(S)",
    "NOMBRE \r\n TOTAL DE  \r\nLIT(S)",
        ...
        <tbody>
          {rowsToShow.map((row, rowIndex) => (
            ...
            {row.map((cell, cellIndex) => (
                <td key={cellIndex} className={`table-cell-auto ${typeof cell === 'number' ? 'text-center' : 'center'}`}>
                {typeof cell === 'number'
...
export default RecapFacturesPayeesPartiellement;
