                    ...
                    <div className="card-body cardBody-3" style={{ textAlign: 'center',width: '90%' }}>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="vide">
                          ...
                          <h6 style={fontSizeH6}>Nombre de plats servis par jour  <br /> <span className="small pt-1 fw-bold" style={fontSizeTEXT}>{numberWithThousandsSeparator(plats_servi.plats_servi ?? 0)}</span>  </h6>
                          <div className="icon">
